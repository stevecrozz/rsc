...
Required parameters:
	instance`,
				...
				CommandFlags: []*metadata.ActionParam{
					...
					&metadata.ActionParam{
						Name:        "instance[features][automation]",
						Description: `Enables running of automation such as RightScripts and Recipes.`,
						Type:        "string",
						Location:    metadata.PayloadParam,
						Mandatory:   false,
						NonBlank:    true,
					...
					&metadata.ActionParam{
						Name:        "instance[features][monitoring]",
...
Required parameters:
	server`,
				...
				CommandFlags: []*metadata.ActionParam{
					...
					&metadata.ActionParam{
						Name:        "server[instance][features][automation]",
						Description: `Enables running of automation such as RightScripts and Recipes.`,
						Type:        "string",
						Location:    metadata.PayloadParam,
						Mandatory:   false,
					...
					&metadata.ActionParam{
						Name:        "server[instance][features][monitoring]",
						Description: `Allow sending of monitoring data.`,
						Type:        "string",
						Location:    metadata.PayloadParam,
						Mandatory:   false,
...
Required parameters:
	server_array`,
				...
				CommandFlags: []*metadata.ActionParam{
					...
					&metadata.ActionParam{
						Name:        "server_array[instance][features][automation]",
						Description: `Enables running of automation such as RightScripts and Recipes.`,
						Type:        "string",
						Location:    metadata.PayloadParam,
						Mandatory:   false,
					...
					&metadata.ActionParam{
						Name:        "server_array[instance][features][monitoring]",
						Description: `Allow sending of monitoring data.`,
						Type:        "string",
						Location:    metadata.PayloadParam,
						Mandatory:   false,
